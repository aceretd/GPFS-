...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
  ...
  .state('question_list', {
    url: '/question-list',
    templateUrl: 'views/gpfs/question/question_list.html',
  ...
  .state('gpfs.update.fs-level-1', {
    url: '/coa/fs-level-1/{fsLevel1Id}',
    templateUrl: 'views/gpfs/gpfs/gpfs-02-coa-fs-lvl-1.html',
    controller: 'GpfsFsLevel1Controller'
  })
  ...
  .state('lockscreen', {
    ...
    data: {
      ...
      specialClass: 'header-none sidebar-none footer-none aqua-bg  login'
    }
  })
  .state('invoice', {
    url: "/invoice",
